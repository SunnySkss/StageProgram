...
public class FragmentTwo extends Fragment implements RecycleAdapter.OnItemClickListener{
   ...
   // private int moviewPoster[]={R.drawable.chak_de_india,R.drawable.lagan};
    public FragmentTwo() {apiInterface=null;
    ...
    private void getList() {
        ...
        Call<List<CreateUserResponse>> call = apiInterface.doCreateUserWithField(1,20,5);
